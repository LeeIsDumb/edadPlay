...
- La exposición temprana a vídeos rápidos y estimulantes puede afectar el desarrollo cerebral infantil.
- Se recomiendan límites claros según edad, priorizando contenidos lentos, educativos y supervisados.
""")
